...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        {            if (curr.Data == value)
            {
                //If it's the first node, use RemoveHead
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If it's the last node, use RemoveTail
                else if (curr == _tail)                
                {
                    RemoveTail();
                }
                ...
                {
                    // If it's a middle node, remove it by updating the links of adjacent nodes
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue; // Update the value of the node containing 'oldValue' to 'newValue'
            }
